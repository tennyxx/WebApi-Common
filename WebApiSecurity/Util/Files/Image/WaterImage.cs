...
public class WaterImageManage
{
                                      ...
                                      string PicturePath)
    {
        ...
        // 目标图片名称及全路径
        //
        string targetImage = sourcePictureName.Replace("_", "_aw_");
        ...
        //在这里我们定义一个数组来确定
        int[] sizes = new int[] { 20, 16, 14, 12, 10, 8, 4 };
        ...
        if (sourcePictureName.Contains("thumb"))
        {
            crFont = new Font("微软雅黑", sizes[3], FontStyle.Italic);
        }
        else if (sourcePictureName.Contains("pc"))
        {
            crFont = new Font("微软雅黑", sizes[5], FontStyle.Italic);
        }
        else if (sourcePictureName.Contains("wap"))
        {
            crFont = new Font("微软雅黑", sizes[6], FontStyle.Italic);
        }
        else
        {
            crFont = new Font("微软雅黑", sizes[3], FontStyle.Italic);
        ...
        //for (int i = 0; i < 7; i++)
        //{
        //    crFont = new Font("宋体", sizes[i], FontStyle.Regular);
        ...
        switch (position)
        {
            ...
            case ImagePosition .Center :
                ...
                {
                    xPosOfWm = phWidth / 2;
                    yPosOfWm = phHeight / 2 + 140;
                }
                else
                {
                    xPosOfWm = phWidth / 2;
                    yPosOfWm = phHeight / 2 + 70;
                }
                break ;
            case ImagePosition .LeftBottom :
                xPosOfWm = wmWidth;
        ...
        //这个画笔为描绘正式文字的笔刷，呈白色
        SolidBrush semiTransBrush = new SolidBrush(Color.FromArgb(150, 255, 255, 255));
